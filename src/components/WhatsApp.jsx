...
const WhatsAppBtn = ({ image, name, href, message }) => {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed flex items-center justify-center p-3 rounded-full bg-green-500 text-white right-5 bottom-5 hover:scale-110 transition-transform"
