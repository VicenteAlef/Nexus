...
const FlipCard = ({ title, face, back }) => {
  const [flipped, setFlipped] = useState(false);

  return (
    <div className="min-w-[200px] max-w-[600px] h-[600px] perspective m-4 sm:m-10">
      <div
      ...
      >
        ...
        {/* Verso */}
        <div
          className="absolute w-full h-full backface-hidden bg-[#0081cc] shadow-lg rounded-2xl p-4 transform rotate-y-180 flex items-center justify-center cursor-pointer"
